...
def attack(char_name: str, char_class: str) -> str:
    """Функция модификатор наносимого урона героем."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция модифицирует щит уменьщающий урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция создает уникальные способности персонажей."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Эта функция проводит начальную тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Эта функция выбора вашего персонажа."""
    approve_choice: str = ''
    char_class: str = ''
